...
export class CategoryListGroupComponent implements OnInit { 
  ...
  constructor(private categoryService: CategoriesService, private change: ChangeDetectorRef){}
  ...
  onChangeSelectEvent(selectedItemId: string | null){
  ...
  get CategoryListGroupItems(): ListGroupItems {
    ...
    //Bu şekilde de yazılabilir: return this.categoryList.map(category => {label: category.name})
  }
}
